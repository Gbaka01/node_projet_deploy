...
"use strict";var influxdb=(()=>{var z=Object.defineProperty;var fr=Object.getOwnPropertyDescriptor;var pr=Object.getOwnPropertyNames;var mr=Object.prototype.hasOwnProperty;var hr=(n,e,t)=>e in n?z(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var H=(n=>typeof require!="undefined"?require:typeof Proxy!="undefined"?new Proxy(n,{get:(e,t)=>(typeof require!="undefined"?require:e)[t]}):n)(function(n){if(typeof require!="undefined")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var dr=(n,e)=>{for(var t in e)z(n,t,{get:e[t],enumerable:!0})},gr=(n,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of pr(e))!mr.call(n,i)&&i!==t&&z(n,i,{get:()=>e[i],enumerable:!(r=fr(e,i))||r.enumerable});return n};var br=n=>gr(z({},"__esModule",{value:!0}),n);var d=(n,e,t)=>hr(n,typeof e!="symbol"?e+"":e,t);var $r={};dr($r,{AbortError:()=>X,DEFAULT_ConnectionOptions:()=>ke,DEFAULT_QueryOptions:()=>ee,DEFAULT_WriteOptions:()=>_e,GetFieldTypeMissmatchError:()=>re,HttpError:()=>E,IllegalArgumentError:()=>R,InfluxDBClient:()=>Y,Log:()=>U,Point:()=>j,PointValues:()=>A,RequestTimedOutError:()=>Ne,collectAll:()=>Rt,consoleLogger:()=>yt,convertTime:()=>Ve,convertTimeToNanos:()=>Be,createTextDecoderCombiner:()=>Ee,currentTime:()=>Nt,dateToProtocolTimestamp:()=>Et,escape:()=>_,fromConnectionString:()=>Se,fromEnv:()=>Re,isNumber:()=>v,parsePrecision:()=>De,precisionToV2ApiString:()=>Ae,precisionToV3ApiString:()=>Pe,setLogger:()=>yr,useProcessHrtime:()=>It,writableDataToLineProtocol:()=>ve});var R=class n extends Error{constructor(e){super(e),this.name="IllegalArgumentError",Object.setPrototypeOf(this,n.prototype)}},E=class n extends Error{constructor(t,r,i,s,o,a){var l;super();this.statusCode=t;this.statusMessage=r;this.body=i;this.contentType=s;this.headers=o;d(this,"code");d(this,"json");if(Object.setPrototypeOf(this,n.prototype),a)this.message=a;else if(i&&(s!=null&&s.startsWith("application/json")||!s))try{if(this.json=JSON.parse(i),this.message=this.json.message,this.code=this.json.code,!this.message){let c=this.json;(l=c.data)!=null&&l.error_message?this.message=c.data.error_message:c.error&&(this.message=c.error)}}catch(c){}this.message||(this.message=`${t} ${r} : ${i}`),this.name="HttpError"}},Ne=class n extends Error{constructor(){super(),Object.setPrototypeOf(this,n.prototype),this.name="RequestTimedOutError",this.message="Request timed out"}},X=class n extends Error{constructor(){super(),this.name="AbortError",Object.setPrototypeOf(this,n.prototype),this.message="Response aborted"}};function Ee(){let n=new TextDecoder("utf-8");return{concat(e,t){let r=new Uint8Array(e.length+t.length);return r.set(e),r.set(t,e.length),r},copy(e,t,r){let i=new Uint8Array(r-t);return i.set(e.subarray(t,r)),i},toUtf8String(e,t,r){return n.decode(e.subarray(t,r))}}}var ke={timeout:1e4,queryTimeout:6e4},_e={precision:"ns",gzipThreshold:1e3,noSync:!1},ee={type:"sql"};function Se(n){if(!n)throw Error("Connection string not set!");let e=new URL(n.trim(),"http://localhost"),t={host:n.indexOf("://")>0?e.origin+e.pathname:e.pathname};return e.searchParams.has("token")&&(t.token=e.searchParams.get("token")),e.searchParams.has("authScheme")&&(t.authScheme=e.searchParams.get("authScheme")),e.searchParams.has("database")&&(t.database=e.searchParams.get("database")),e.searchParams.has("timeout")&&(t.timeout=parseInt(e.searchParams.get("timeout"))),e.searchParams.has("precision")&&(t.writeOptions||(t.writeOptions={}),t.writeOptions.precision=De(e.searchParams.get("precision"))),e.searchParams.has("gzipThreshold")&&(t.writeOptions||(t.writeOptions={}),t.writeOptions.gzipThreshold=parseInt(e.searchParams.get("gzipThreshold"))),e.searchParams.has("writeNoSync")&&(t.writeOptions||(t.writeOptions={}),t.writeOptions.noSync=bt(e.searchParams.get("writeNoSync"))),t}function Re(){if(!process.env.INFLUX_HOST)throw Error("INFLUX_HOST variable not set!");if(!process.env.INFLUX_TOKEN)throw Error("INFLUX_TOKEN variable not set!");let n={host:process.env.INFLUX_HOST.trim()};if(process.env.INFLUX_TOKEN&&(n.token=process.env.INFLUX_TOKEN.trim()),process.env.INFLUX_AUTH_SCHEME&&(n.authScheme=process.env.INFLUX_AUTH_SCHEME.trim()),process.env.INFLUX_DATABASE&&(n.database=process.env.INFLUX_DATABASE.trim()),process.env.INFLUX_TIMEOUT&&(n.timeout=parseInt(process.env.INFLUX_TIMEOUT.trim())),process.env.INFLUX_PRECISION&&(n.writeOptions||(n.writeOptions={}),n.writeOptions.precision=De(process.env.INFLUX_PRECISION)),process.env.INFLUX_GZIP_THRESHOLD&&(n.writeOptions||(n.writeOptions={}),n.writeOptions.gzipThreshold=parseInt(process.env.INFLUX_GZIP_THRESHOLD)),process.env.INFLUX_WRITE_NO_SYNC&&(n.writeOptions||(n.writeOptions={}),n.writeOptions.noSync=bt(process.env.INFLUX_WRITE_NO_SYNC)),process.env.INFLUX_GRPC_OPTIONS){let e=process.env.INFLUX_GRPC_OPTIONS.split(",");n.grpcOptions||(n.grpcOptions={});for(let t of e){let r=t.split("=");if(r.length!=2)continue;let i=parseInt(r[1]);Number.isNaN(i)&&(i=parseFloat(r[1]),Number.isNaN(i)&&(i=r[1])),n.grpcOptions[r[0]]=i}}return n}function bt(n){return["true","1","t","y","yes"].includes(n.trim().toLowerCase())}function Ae(n){switch(n){case"ns":case"us":case"ms":case"s":return n;default:throw Error(`Unsupported precision '${n}'`)}}function Pe(n){switch(n){case"ns":return"nanosecond";case"us":return"microsecond";case"ms":return"millisecond";case"s":return"second";default:throw Error(`Unsupported precision '${n}'`)}}function De(n){switch(n.trim().toLowerCase()){case"ns":case"nanosecond":return"ns";case"us":case"microsecond":return"us";case"ms":case"millisecond":return"ms";case"s":case"second":return"s";default:throw Error(`Unsupported precision '${n}'`)}}var yt={error(n,e){console.error(`ERROR: ${n}`,e||"")},warn(n,e){console.warn(`WARN: ${n}`,e||"")}},te=yt,U={error(n,e){te.error(n,e)},warn(n,e){te.warn(n,e)}};function yr(n){let e=te;return te=n,e}function Ue(n,e){return function(t){let r="",i=0,s=0;for(;s<t.length;){let o=n.indexOf(t[s]);o>=0&&(r+=t.substring(i,s),r+=e[o],i=s+1),s++}return i==0?t:(i<t.length&&(r+=t.substring(i,t.length)),r)}}function wr(n,e){let t=Ue(n,e);return r=>`"${t(r)}"`}var _={measurement:Ue(`, 
\r	`,["\\,","\\ ","\\n","\\r","\\t"]),quoted:wr('"\\',['\\"',"\\\\"]),tag:Ue(`, =
\r	`,["\\,","\\ ","\\=","\\n","\\r","\\t"])};var xt="000000000";function It(n){return!1}It(!0);var wt=Date.now(),Ce=0;function Le(){{let n=Date.now();n!==wt?(wt=n,Ce=0):Ce++;let e=String(Ce);return String(n)+xt.substr(0,6-e.length)+e}}function Tt(){return String(Date.now())+xt.substr(0,3)}function Ot(){return String(Date.now())}function Ft(){return String(Math.floor(Date.now()/1e3))}var Nt={s:Ft,ms:Ot,us:Tt,ns:Le,seconds:Ft,millis:Ot,micros:Tt,nanos:Le},Et={s:n=>`${Math.floor(n.getTime()/1e3)}`,ms:n=>`${n.getTime()}`,us:n=>`${n.getTime()}000`,ns:n=>`${n.getTime()}000000`};function Be(n){return n===void 0?Le():typeof n=="string"?n.length>0?n:void 0:n instanceof Date?`${n.getTime()}000000`:String(typeof n=="number"?Math.floor(n):n)}var Ve=(n,e="ns")=>n===void 0?Nt[e]():typeof n=="string"?n.length>0?n:void 0:n instanceof Date?Et[e](n):String(typeof n=="number"?Math.floor(n):n);var V=n=>{throw n},kt=n=>n!==void 0,_t=n=>n instanceof Array||n instanceof Object&&typeof n.length=="number"&&(n.length===0||Object.getOwnPropertyNames(n).some(e=>e==="0")),St=n=>{let e=new Uint8Array(4);return e[0]=n>>0,e[1]=n>>8,e[2]=n>>16,e[3]=n>>24,e},Rt=async n=>{let e=[];for await(let t of n)e.push(t);return e},v=n=>n===null||typeof n=="string"&&(n===""||n.indexOf(" ")!==-1)?!1:n!==""&&!isNaN(Number(n==null?void 0:n.toString())),At=n=>v(n)?typeof n=="string"?Number(n)>=0:typeof n=="number"&&n>=0:!1;var ve=(n,e)=>{let t=_t(n)&&typeof n!="string"?Array.from(n):[n];return t.length===0?[]:typeof t[0]=="string"?t:t.map(i=>i.toLineProtocol(void 0,e)).filter(kt)};var Tr=n=>typeof n=="number"?"float":typeof n=="string"?"string":typeof n=="boolean"?"boolean":void 0,re=class n extends Error{constructor(e,t,r){super(`field ${e} of type ${r} doesn't match expected type ${t}!`),this.name="GetFieldTypeMissmatchError",Object.setPrototypeOf(this,n.prototype)}},A=class n{constructor(){d(this,"_name");d(this,"_time");d(this,"_tags",{});d(this,"_fields",{})}getMeasurement(){return this._name}setMeasurement(e){return this._name=e,this}getTimestamp(){return this._time}setTimestamp(e){return this._time=e,this}getTag(e){return this._tags[e]}setTag(e,t){return this._tags[e]=t,this}removeTag(e){return delete this._tags[e],this}getTagNames(){return Object.keys(this._tags)}getFloatField(e){return this.getField(e,"float")}setFloatField(e,t){let r;if(typeof t=="number"?r=t:r=parseFloat(t),!isFinite(r))throw new Error(`invalid float value for field '${e}': '${t}'!`);return this._fields[e]=["float",r],this}getIntegerField(e){return this.getField(e,"integer")}setIntegerField(e,t){let r;if(typeof t=="number"?r=t:r=parseInt(String(t)),isNaN(r)||r<=-9223372036854776e3||r>=9223372036854776e3)throw new Error(`invalid integer value for field '${e}': '${t}'!`);return this._fields[e]=["integer",Math.floor(r)],this}getUintegerField(e){return this.getField(e,"uinteger")}setUintegerField(e,t){if(typeof t=="number"){if(isNaN(t)||t<0||t>Number.MAX_SAFE_INTEGER)throw new Error(`uint value for field '${e}' out of range: ${t}`);this._fields[e]=["uinteger",Math.floor(t)]}else{let r=String(t);for(let i=0;i<r.length;i++){let s=r.charCodeAt(i);if(s<48||s>57)throw new Error(`uint value has an unsupported character at pos ${i}: ${t}`)}if(r.length>20||r.length===20&&r.localeCompare("18446744073709551615")>0)throw new Error(`uint value for field '${e}' out of range: ${r}`);this._fields[e]=["uinteger",+r]}return this}getStringField(e){return this.getField(e,"string")}setStringField(e,t){return t!=null&&(typeof t!="string"&&(t=String(t)),this._fields[e]=["string",t]),this}getBooleanField(e){return this.getField(e,"boolean")}setBooleanField(e,t){return this._fields[e]=["boolean",!!t],this}getField(e,t){let r=this._fields[e];if(!r)return;let[i,s]=r;if(t!==void 0&&t!==i)throw new re(e,t,i);return s}getFieldType(e){let t=this._fields[e];if(t)return t[0]}setField(e,t,r){switch(r!=null?r:Tr(t)){case"string":return this.setStringField(e,t);case"boolean":return this.setBooleanField(e,t);case"float":return this.setFloatField(e,t);case"integer":return this.setIntegerField(e,t);case"uinteger":return this.setUintegerField(e,t);case void 0:return this;default:throw new Error(`invalid field type for field '${e}': type -> ${r}, value -> ${t}!`)}}setFields(e){for(let[t,r]of Object.entries(e))this.setField(t,r);return this}removeField(e){return delete this._fields[e],this}getFieldNames(){return Object.keys(this._fields)}hasFields(){return this.getFieldNames().length>0}copy(){let e=new n;return e._name=this._name,e._time=this._time,e._tags=Object.fromEntries(Object.entries(this._tags)),e._fields=Object.fromEntries(Object.entries(this._fields).map(t=>[...t])),e}asPoint(e){return j.fromValues(e?this.setMeasurement(e):this)}};var Or=(n,e)=>{switch(n){case"string":return _.quoted(e);case"boolean":return e?"T":"F";case"float":return`${e}`;case"integer":return`${e}i`;case"uinteger":return`${e}u`}},j=class n{constructor(e){d(this,"_values");e instanceof A?this._values=e:this._values=new A,typeof e=="string"&&this._values.setMeasurement(e)}static measurement(e){return new n(e)}static fromValues(e){if(!e.getMeasurement()||e.getMeasurement()==="")throw new Error("Cannot convert values to point without measurement set!");return new n(e)}getMeasurement(){return this._values.getMeasurement()}setMeasurement(e){return e!==""&&this._values.setMeasurement(e),this}getTimestamp(){return this._values.getTimestamp()}setTimestamp(e){return this._values.setTimestamp(e),this}getTag(e){return this._values.getTag(e)}setTag(e,t){return this._values.setTag(e,t),this}removeTag(e){return this._values.removeTag(e),this}getTagNames(){return this._values.getTagNames()}getFloatField(e){return this._values.getFloatField(e)}setFloatField(e,t){return this._values.setFloatField(e,t),this}getIntegerField(e){return this._values.getIntegerField(e)}setIntegerField(e,t){return this._values.setIntegerField(e,t),this}getUintegerField(e){return this._values.getUintegerField(e)}setUintegerField(e,t){return this._values.setUintegerField(e,t),this}getStringField(e){return this._values.getStringField(e)}setStringField(e,t){return this._values.setStringField(e,t),this}getBooleanField(e){return this._values.getBooleanField(e)}setBooleanField(e,t){return this._values.setBooleanField(e,t),this}getField(e,t){return this._values.getField(e,t)}getFieldType(e){return this._values.getFieldType(e)}setField(e,t,r){return this._values.setField(e,t,r),this}setFields(e){return this._values.setFields(e),this}removeField(e){return this._values.removeField(e),this}getFieldNames(){return this._values.getFieldNames()}hasFields(){return this._values.hasFields()}copy(){return new n(this._values.copy())}toLineProtocol(e,t){if(!this._values.getMeasurement())return;let r="";if(this._values.getFieldNames().sort().forEach(a=>{if(a){let l=this._values.getFieldType(a),c=this._values.getField(a);if(l===void 0||c===void 0)return;let f=Or(l,c);r.length>0&&(r+=","),r+=`${_.tag(a)}=${f}`}}),r.length===0)return;let i="",s=this._values.getTagNames();if(t){let a=new Set(s),l=Object.keys(t);for(let c=l.length;c--;)a.has(l[c])&&l.splice(c,1);l.sort().forEach(c=>{if(c){let f=t[c];f&&(i+=",",i+=`${_.tag(c)}=${_.tag(f)}`)}})}s.sort().forEach(a=>{if(a){let l=this._values.getTag(a);l&&(i+=",",i+=`${_.tag(a)}=${_.tag(l)}`)}});let o=this._values.getTimestamp();return e?typeof e=="string"?o=Ve(o,e):o=e(o):o=Be(o),`${_.measurement(this.getMeasurement())}${i} ${r}${o!==void 0?` ${o}`:""}`}toString(){let e=this.toLineProtocol(void 0);return e||`invalid point: ${JSON.stringify(this,void 0)}`}};function Me(n={}){let e=0,t={next:r=>{if(e===0&&n.next&&r!==null&&r!==void 0)return n.next(r)},error:r=>{e===0&&(e=1,n.error&&n.error(r))},complete:()=>{e===0&&(e=2,n.complete&&n.complete())},responseStarted:(r,i)=>{n.responseStarted&&n.responseStarted(r,i)}};return n.useCancellable&&(t.useCancellable=n.useCancellable.bind(n)),n.useResume&&(t.useResume=n.useResume.bind(n)),t}function ne(n){let e={};return n.headers.forEach((t,r)=>{let i=e[r];i===void 0?e[r]=t:Array.isArray(i)?i.push(t):e[r]=[i,t]}),e}var J=class{constructor(e){this._connectionOptions=e;d(this,"chunkCombiner",Ee());d(this,"_defaultHeaders");d(this,"_url");d(this,"requestDecorator",function(){});var t;if(this._defaultHeaders={"content-type":"application/json; charset=utf-8",...e.headers},this._connectionOptions.token){let r=(t=this._connectionOptions.authScheme)!=null?t:"Token";this._defaultHeaders.Authorization=`${r} ${this._connectionOptions.token}`}this._url=String(this._connectionOptions.host),this._url.endsWith("/")&&(this._url=this._url.substring(0,this._url.length-1)),this._url.endsWith("/api/v2")&&(this._url=this._url.substring(0,this._url.length-7),U.warn(`Please remove '/api/v2' context path from InfluxDB base url, using ${this._url} !`))}send(e,t,r,i){let s=Me(i),o=!1,a=r.signal,l,c=()=>{},f=c;if(i&&i.useCancellable){let m=new AbortController;a||(a=m.signal,r={...r,signal:a}),a.addEventListener("abort",()=>{f()}),i.useCancellable({cancel(){o=!0,m.abort()},isCancelled(){return o||a.aborted}})}this._fetch(e,t,r).then(async m=>{if(i!=null&&i.responseStarted&&s.responseStarted(ne(m),m.status),await this._throwOnErrorResponse(m),m.body){let p=m.body.getReader(),F;do{if(l&&await l,o)break;if(F=await p.read(),s.next(F.value)===!1){let h=s.useResume;if(!h){let x="Unable to pause, useResume is not configured!";return await p.cancel(x),Promise.reject(new Error(x))}l=new Promise(x=>{f=()=>{x(),l=void 0,f=c},h(f)})}}while(!F.done)}else if(m.arrayBuffer){let p=await m.arrayBuffer();s.next(new Uint8Array(p))}else{let p=await m.text();s.next(new TextEncoder().encode(p))}}).catch(m=>{o||s.error(m)}).finally(()=>s.complete())}async _throwOnErrorResponse(e){if(e.status>=300){let t="";try{if(t=await e.text(),!t){let r=e.headers.get("x-influxdb-error");r&&(t=r)}}catch(r){throw U.warn("Unable to receive error body",r),new E(e.status,e.statusText,void 0,e.headers.get("content-type"),ne(e))}throw new E(e.status,e.statusText,t,e.headers.get("content-type"),ne(e))}}async*iterate(e,t,r){var s;let i=await this._fetch(e,t,r);if(await this._throwOnErrorResponse(i),i.body){let o=i.body.getReader();for(;;){let{value:a,done:l}=await o.read();if(l)break;if((s=r.signal)!=null&&s.aborted)throw await i.body.cancel(),new X;yield a}}else if(i.arrayBuffer){let o=await i.arrayBuffer();yield new Uint8Array(o)}else{let o=await i.text();yield new TextEncoder().encode(o)}}async request(e,t,r,i){var c,f;let s=await this._fetch(e,t,r),{headers:o}=s,a=o.get("content-type")||"";i&&i(ne(s),s.status),await this._throwOnErrorResponse(s);let l=(f=(c=r.headers)==null?void 0:c.accept)!=null?f:a;if(l.includes("json"))return await s.json();if(l.includes("text")||l.startsWith("application/csv"))return await s.text()}_fetch(e,t,r){let{method:i,headers:s,...o}=r,a=`${this._url}${e}`,l={method:i,body:i==="GET"||i==="HEAD"?void 0:typeof t=="string"?t:JSON.stringify(t),headers:{...this._defaultHeaders,...s},credentials:"omit",...this._connectionOptions.transportOptions,...o};return this.requestDecorator(l,r,a),fetch(a,l)}};var Pt=H("@protobuf-ts/grpcweb-transport"),Dt=({host:n,timeout:e,clientOptions:t})=>{var r;return(t!=null&&t.grpcOptions||(r=t==null?void 0:t.queryOptions)!=null&&r.grpcOptions)&&console.warn(`Detected grpcClientOptions: such options are ignored in the GrpcWebFetchTransport:
